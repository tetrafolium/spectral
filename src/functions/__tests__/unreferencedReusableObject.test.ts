...
function runUnreferencedReusableObject(data: any,
                                       reusableObjectsLocation: string) {
  return unreferencedReusableObject(data, {reusableObjectsLocation},
                                    {given : [ '$' ]}, {
                                      given : null,
                                      original : null,
                                    } as any);
...
describe('unreferencedReusableObject', () => {
  test(
      'throws when reusableObjectsLocation does not look like a valid local json pointer',
      () => {
