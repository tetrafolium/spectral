...
const applyRuleToObject =
    async(r: IRule, o: object): Promise<IRuleResult[]> => {
...
describe('functions', () => {
  ...
  describe('pattern', () => {
    ...
    test('returns resolved if pattern is not matched (on object keys)',
         async () => {
           expect(
               applyRuleToObject(
                   {
    ...
    test('dont return resolved if pattern is matched (on object keys)',
         async () => {
           expect(
               applyRuleToObject(
                   {
  ...
  describe('length', () => {
    ...
    test(
        'return resolved if string, number, array, or object is greater than max',
        async () => {
          expect(
              applyRuleToObject(
                  {
    ...
    test('return resolved if string, number, array, or object is less than min',
         async () => {
           expect(
               applyRuleToObject(
                   {
    ...
    test(
        'dont return a resolved if string, number, array, or object is between min and max',
        async () => {
          expect(
              applyRuleToObject(
                  {
