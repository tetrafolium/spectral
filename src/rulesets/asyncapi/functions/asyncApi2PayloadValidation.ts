...
const asyncApi2SchemaObject = {
  $ref : fakeSchemaObjectId
};

let validator: ValidateFunction;

const buildAsyncApi2SchemaObjectValidator =
    (schemaFn: ISchemaFunction): ValidateFunction => {
      if (validator !== void 0) {
        return validator;
      }
...
export const asyncApi2PayloadValidation: IFunction<null> = function(
  ...
  const ajvValidationFn =
      buildAsyncApi2SchemaObjectValidator(this.functions.schema);
