  ...
  describe('when loaded from a ruleset', () => {
    ...
    describe('Validation', () => {
      describe('Invalid locations', () => {
        ...
        it.each(invalidLocations)(
            ...
            async location => {
              ...
              expect(() => { mergeExceptions({}, source, dummyRulesetUri); })
                  .toThrow(
                      new RegExp(
                          `.+\`${escapeRegExp(dummyRulesetUri)}\`.+\\(key \`${
                              escapeRegExp(location)}\`.+is not a valid uri`,
                          ),
                  );
            },
        );
      ...
      describe('throws on empty rule name', () => {
        const location = 'one.yaml#/';
        const source =
            buildRulesetExceptionCollectionFrom(location, [ 'b', '' ]);
    ...
    describe('Normalization', () => {
      const relativeLocations: Array<[ string, string, string ]> = [
        ...
        [ '../ruleset.yaml', '../one.yaml#/toto', '../../one.yaml#/toto' ],
        [
          'https://dot.com/r/ruleset.yaml', 'one.yaml#',
          'https://dot.com/r/one.yaml#'
        ],
        [
          'https://dot.com/r/ruleset.yaml', 'one.yaml#/',
          'https://dot.com/r/one.yaml#/'
        ...
        [
          'https://dot.com/r/ruleset.yaml', 'one.yaml#/toto',
          'https://dot.com/r/one.yaml#/toto'
        ],
        [
          'https://dot.com/r/ruleset.yaml', 'down/one.yaml#/toto',
          'https://dot.com/r/down/one.yaml#/toto'
        ],
        [
          'https://dot.com/r/ruleset.yaml', '../one.yaml#/toto',
      ...
      it.each(relativeLocations)(
          ...
          (rulesetUri, location, expectedLocation) => {
            ...
            const expected =
                buildRulesetExceptionCollectionFrom(expectedLocation);
      ...
      const absoluteLocations: Array<[ string, string, string ]> = [
        [
          './ruleset.yaml', 'https://dot.com/one.yaml#/toto',
          'https://dot.com/one.yaml#/toto'
        ],
        [
          '../ruleset.yaml', 'https://dot.com/one.yaml#/toto',
        ...
        [
          'https://dot.com/r/ruleset.yaml', 'https://dot.com/one.yaml#/toto',
          'https://dot.com/one.yaml#/toto'
        ],
        [ './ruleset.yaml', '/local/one.yaml#/toto', '/local/one.yaml#/toto' ],
        [ '../ruleset.yaml', '/local/one.yaml#/toto', '/local/one.yaml#/toto' ],
        [
          'https://dot.com/r/ruleset.yaml', '/local/one.yaml#/toto',
          '/local/one.yaml#/toto'
        ],
        [ './ruleset.yaml', 'c:/one.yaml#/toto', 'c:/one.yaml#/toto' ],
        [ '../ruleset.yaml', 'c:/one.yaml#/toto', 'c:/one.yaml#/toto' ],
        [
          'https://dot.com/r/ruleset.yaml', 'c:/one.yaml#/toto',
          'c:/one.yaml#/toto'
        ],
        [ './ruleset.yaml', 'c:\\one.yaml#/toto', 'c:/one.yaml#/toto' ],
        [ '../ruleset.yaml', 'c:\\one.yaml#/toto', 'c:/one.yaml#/toto' ],
