        ...
        testsuite : [
          {
            $ : {
              ...
              failures : '3',
              name :
                  '/home/Stoplight/spectral/src/__tests__/__fixtures__/petstore.invalid-schema.oas3.yaml',
            ...
            testcase : [
              {
                $ : {
                  classname :
                      '/home/Stoplight/spectral/src/__tests__/__fixtures__/petstore.invalid-schema.oas3',
            ...
            testcase : [
              {
                $ : {
                  classname :
                      '/home/Stoplight/spectral/src/__tests__/__fixtures__/petstore.oas3',
