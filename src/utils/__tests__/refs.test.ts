...
describe('$ref utils', () => {
  describe('traverseObjUntilRef', () => {
    it('given a broken json path, throws', () => {
      ...
      expect(traverseObjUntilRef.bind(null, obj, [ 'foo', 'baz' ]))
          .toThrow('Segment is not a part of the object');
      expect(traverseObjUntilRef.bind(null, obj, [ 'bar', 'foo' ]))
          .toThrow('Segment is not a part of the object');
    });
    ...
    it('given a json path pointing at object with ref, returns the ref', () => {
      ...
      expect(traverseObjUntilRef(obj, [ 'foo', 'bar', 'baz' ]))
          .toEqual('../a.json#');
    });
