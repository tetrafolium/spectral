...
const compareCode = (left: string|number|undefined,
                     right: string|number|undefined): number => {
...
const compareSource =
    (left: string|undefined, right: string|undefined): number => {
      if (left === void 0 && right === void 0) {
        return 0;
      }
...
export const compareResults =
    (left: IRuleResult, right: IRuleResult): -1|0|1 => {
...
export const sortResults =
    (results: IRuleResult[]) => { return [...results ].sort(compareResults);};
