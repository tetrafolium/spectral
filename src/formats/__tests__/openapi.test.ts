...
describe('OpenAPI format', () => {
  describe('OpenAPI 2.0 aka Swagger', () => {
    it.each([ '2.0.0', '2', '2.0' ])(
        ...
        version => { expect(isOpenApiv2({swagger : version})).toBe(true); });
  ...
  describe('OpenAPI 3.0', () => {
    it.each([ '3.0.0', '3', '3.0' ])(
        'recognizes %s version correctly',
        version => { expect(isOpenApiv3({openapi : version})).toBe(true); });
  ...
  describe('OpenAPI 3.1', () => {
    it.each([ '3.1.0', '3.1' ])(
        'recognizes %s version correctly',
        version => { expect(isOpenApiv3_1({openapi : version})).toBe(true); });
